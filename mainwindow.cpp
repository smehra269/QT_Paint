...
MainWindow::MainWindow()
{
    ...
    connect(squareButton, SIGNAL(clicked()), this, SLOT(createSquare()));
    connect(circleButton, SIGNAL(clicked()), this, SLOT(createCircle()));

    QVBoxLayout *leftLayout = new QVBoxLayout;
    leftLayout->addWidget(squareButton);
    leftLayout->addWidget(circleButton);
    ...
    splitter->addWidget(scribbleArea);
...
{
    scribbleArea->createSquare();
}

void MainWindow::createCircle()
{
    scribbleArea->createCircle();
}
...
{
    QMessageBox::about(this, tr("About Scribble"), tr("<p>The <b>Scribble</b> example is from Siddharth</p>"));
}
